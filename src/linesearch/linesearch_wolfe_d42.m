...
% linesearch_wolfe_d42  Wrapper around legacy dwolfe42.m (3 objectives, epsiki).
...
nf = 0; ng = 0;
[alpha, nf, ng] = dwolfe42(x, dvec, alphamax, epsiki, sigmaba, rhoba, nf, ng, probId, r1, r2, r3);
info = struct('name','dwolfe42','nf',nf,'ng',ng,'epsiki',epsiki);
end

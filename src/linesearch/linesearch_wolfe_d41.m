...
% linesearch_wolfe_d41  Wrapper around legacy dwolfe41.m (3 objectives, epsiki).
...
nf = 0; ng = 0;
[alpha, nf, ng] = dwolfe41(x, dvec, alphamax, epsiki, sigmaba, rhoba, nf, ng, probId, r1, r2, r3);
info = struct('name','dwolfe41','nf',nf,'ng',ng,'epsiki',epsiki);
end

...
x_01 = zeros(1,m);
for i=1:m, x_01(i) = min(HH(:,i)); end
x_N11 = zeros(1,m);
for i=1:m, x_N11(i) = max(HH(:,i)); end

x_02 = zeros(1,m);
for i=1:m, x_02(i) = min(HH(:,i)); end
x_N12 = zeros(1,m);
for i=1:m, x_N12(i) = max(HH(:,i)); end

x_03 = zeros(1,m);
for i=1:m, x_03(i) = min(HH(:,i)); end
x_N13 = zeros(1,m);
for i=1:m, x_N13(i) = max(HH(:,i)); end

x_04 = zeros(1,m);
for i=1:m, x_04(i) = min(HH(:,i)); end
x_N14 = zeros(1,m);
for i=1:m, x_N14(i) = max(HH(:,i)); end

...
function [alphak,nf,ng]=dwolfe2(xk,dk,alphamax,sigmaba,rhoba,nf,ng,d,r1,r2)
...
while i<imax
    if r2*f2(xk+alpha1*dk,d)>r2*f2(xk,d)+alpha1*rhoba*max([r1*g1(xk,d)'*dk,r2*g2(xk,d)'*dk]) || (r2*f2(xk+alpha1*dk,d)>=r2*f2(xk+alpha0*dk,d) &&  i>1)
       nf=nf+2;
        [alphak,nf,ng]=zoom21(alpha0,alpha1,xk,dk,sigmaba,rhoba,nf,ng,d,r1,r2);
        break;
    end
    ...
    if r2*g2(xk+alpha1*dk,d)'*dk>=0
        ng=ng+1;
        [alphak,nf,ng]=zoom22(alpha1,alpha0,xk,dk,sigmaba,rhoba,nf,ng,d,r1,r2);
        break;
    end
